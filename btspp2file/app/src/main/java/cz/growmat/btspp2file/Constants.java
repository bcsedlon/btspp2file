...
public class Constants {
    ...
    public static final String DEFAULT_PATH = "/btspp2file/";
    public static final String DEFAULT_TX_FILENAME = "tx.txt";
    public static final String DEFAULT_RX_FILENAME = "rx.txt";
    public static final String DEFAULT_LOG_FILENAME = "btspp2file.log";
}
